    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('Agent', 'agent'), ('Doctor', 'doctor'), ('Medicalshop', 'medicalshop')], max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('agency_name', models.CharField(max_length=120, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('blood_type', models.CharField(choices=[('O+', 'O+'), ('A+', 'A-'), ('B+', 'B-'), ('AB+', 'AB-')], max_length=20)),
                ('agent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='medical.agentdetails')),
            ],
        ),
        migrations.CreateModel(
            name='MedicalshopDetails',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
